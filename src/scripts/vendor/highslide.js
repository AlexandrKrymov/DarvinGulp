...
graphicsDir : 'assets/images/highslide/',
...
outlineStartOffset : 0, // ends at 10
marginLeft : 10,
...
fullExpandTitle : 'Раскрыть в оригинальном размере',
restoreTitle : 'Щелкните чтобы закрыть, нажмите и удерживайте для перемещения, используйте клавиши стрелок для перехода к следующему или предыдущему',
focusTitle : 'Щелкните чтобы переместить на передний план',
